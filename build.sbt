...
lazy val plugin = (project in file("."))
  .settings(
    ...
    graalVMNativeImageOptions ++= Seq(
      ...
      "--initialize-at-build-time=org.slf4j.MDC,ch.qos.logback,org.apache.log4j,org.slf4j.helpers,com.fasterxml.jackson.core.Base64Variant,org.xml.sax.helpers.AttributesImpl,org.xml.sax.helpers.LocatorImpl",
      "--verbose",
